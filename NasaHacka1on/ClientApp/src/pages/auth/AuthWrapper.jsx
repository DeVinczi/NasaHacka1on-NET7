  ...
  return (
    <div className="auth-container mx-auto mt-3 py-3 px-1 border border-1 shadow">
      <div className="d-flex flex-column align-items-center">
              ...
              >
                  <a className="d-flex align-items-center justify-content-center text-decoration-none text-dark" href="https://localhost:7120/api/login/facebook">
          <i className="bi bi-facebook" style={{ fontSize: "1.4em" }}></i>
              ...
              <button className="btn btn-outline-dark border-2 col-11 col-md-10 col-xxl-7 d-flex align-items-center justify-content-center my-2">
                  <a className="d-flex align-items-center justify-content-center text-decoration-none text-dark" href="https://localhost:7120/api/login/github">
          <i
          ...
          ></i>
              ...
              <button className="btn btn-outline-dark border-2 col-11 col-md-10 col-xxl-7 d-flex align-items-center justify-content-center my-3">
                  <a className="d-flex align-items-center justify-content-center text-decoration-none text-dark" href="https://localhost:7120/api/login/google">
